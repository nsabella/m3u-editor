                ...
                BulkAction::make('add_to_group')
                    ...
                    ->action(function (Collection $records, $data) use ($ownerRecord): void {
                        ...
                        Notification::make()
                            ...
                            ->body(__('The selected channels have been added to the custom groups.'))
                            ->send();
                    })
                    ->deselectRecordsAfterCompletion()
                    ->requiresConfirmation()
                    ...
                    ->modalDescription(__('Add channels to multiple custom groups'))
                ...
                BulkAction::make('remove_from_group')
                    ...
                    ->action(function (Collection $records, $data) use ($ownerRecord): void {
                        ...
                        Notification::make()
                            ...
                            ->body(__('The selected channels have been removed from the chosen groups.'))
                            ->send();
                    })
                    ->deselectRecordsAfterCompletion()
                    ->requiresConfirmation()
                    ...
                    ->color('warning')
                    ->modalDescription(__('Remove channels from selected custom groups'))
